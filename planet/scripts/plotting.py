...
def benchmark(logdirs, outdir, tag):
    ...
    phase = np.array([10, 50, 100]).astype(int) + 1
    bin_s = int(1)
...
if __name__ == '__main__':
    # main(parse_args())
    logdirs = ['logload/finger_spin/*/test']
    tag = 'trainer_graph_phase_test_cond_2_trainer_test_score'
    benchmark(logdirs, 'events', tag)
