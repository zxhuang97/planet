...
python3 -m planet.scripts.train --logdir log/rand_traj
--params "{tasks: [cheetah_run],r_loss: contra,contra_h: 12,
 contra_unit: traj, reward_loss_scale: 10.0, resample=5}" --num_runs 2 --resume_runs False
For debugging:
...
def process(logdir, args):
    ...
    dataset = tools.numpy_episodes.numpy_episodes(
        ...
        simclr=config.contra_unit == 'simclr')
